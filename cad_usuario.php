                        ...
                        <div class="card-body">
                            ...
                            <form id="cadastroUsuarioForm" method="POST" action="./controllers/controller_usuario.php"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputNome" name="nome" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail">Endereço de Email</label>
                                    <input id="inputEmail" name="email" type="email" placeholder="exemplo@dominio.com"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputSenha" name="senha" type="password" placeholder="Senha"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputConfirmaSenha" name="confirm-senha" type="password"
                                        placeholder="Confirme a Senha" class="form-control" minlength="6" required>
                                    <small id="senhaFeedback" class="form-text"></small>
                                </div>
                                <div class="form-group">
                                    <label for="inputTelefone">Telefone</label>
                                    <input id="inputTelefone" name="contacto" type="tel"
